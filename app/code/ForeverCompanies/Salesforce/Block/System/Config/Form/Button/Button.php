...
namespace ForeverCompanies\Salesforce\Block\System\Config\Form\Button;
 ...
 *
 * @package ForeverCompanies\Salesforce\Block\System\Config\Form\Button
 * @method string getButtonLabel()
 * @method string getHtmlId()
 * @method string getButtonUrl()
 */
class Button extends ConfirmFormField
{
    /**
     * Sync Button Label
     *
     ...
     * Set template
     *
     * @return \ForeverCompanies\Salesforce\Block\System\Config\Form\Button\Button
     */
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $router = !empty($originalData['button_url']) ? $originalData['button_url']
            : '*/dashboard/index';
        $this->addData([
