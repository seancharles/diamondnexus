...
class RemoveSetting extends \ForeverCompanies\Profile\Controller\ApiController
{
    ...
    public function execute()
    {
        try {
            ...
            if ($this->profileHelper->formKeyValidator->validate($this->getRequest())) {
                ...
                $this->profileHelper->setProfileBuilderKey('type', null);
                $this->profileHelper->setProfileBuilderKey('setting', null);
                $this->profileHelper->setProfileBuilderKey('setting_sku', null);
                    
                $this->resultHelper->addSuccessMessage('Setting was removed from session.');
