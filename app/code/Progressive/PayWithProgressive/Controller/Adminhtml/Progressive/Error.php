...
namespace Progressive\PayWithProgressive\Controller\Adminhtml\Progressive;
 ...
 *
 * @package Progressive\PayWithProgressive\Controller\Adminhtml\Cancel
 */
class Error extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Progressive error page'));
        return $resultPage;
    }
}
