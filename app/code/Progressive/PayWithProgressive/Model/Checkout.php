...
/**
 * Class Checkout for Progressive
 * This class is a wrapper for the Progressive checkout process
 *
 * @package Progressive\PayWithProgressive\Model
 */
class Checkout
{
    /**
    ...
    /**
     * Progressive payment config model
     *
    ...
    public function __construct(
        ...
        if (isset($params['config']) && $params['config'] instanceof ProgressiveConfig) {
    ...
    public function place($token)
    {
        ...
        if (!$token) {
            throw new \Magento\Framework\Exception\LocalizedException(
                __(
                    'Token not found in lease verification response.'
                )
            );
        }
	...
	// Temporarily set the tax class ID for each product in the quote to be non-taxable. DO NOT SAVE THE MODIFIED PRODUCT
