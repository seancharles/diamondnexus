...
class WidgetProgBanner extends Template implements BlockInterface {
    protected $_template = "Progressive_PayWithProgressive::widget/ECOM_Banner_Custom.phtml";
    protected $_system;
    protected $_config;
    protected $_data;
    ...
    {
 	   return 'Progressive_PayWithProgressive::images/' . $this->_data['img_url'];
    }
